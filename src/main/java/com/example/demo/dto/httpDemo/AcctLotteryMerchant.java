...
public class AcctLotteryMerchant implements java.io.Serializable{
	...
	/*身份证正面*/
	private MultipartFile idCardZ;

	/*身份证反面*/
	private MultipartFile idCardF;

	/*银行卡正面*/
	private MultipartFile bankCard;

	/*手持身份证正面照*/
	private MultipartFile hardIdCardZ;

	public AcctLotteryMerchant(){
	}
	...
	public MultipartFile getIdCardZ() {
		return idCardZ;
	}

	public void setIdCardZ(MultipartFile idCardZ) {
		this.idCardZ = idCardZ;
	}

	public MultipartFile getIdCardF() {
		return idCardF;
	}

	public void setIdCardF(MultipartFile idCardF) {
		this.idCardF = idCardF;
	}

	public MultipartFile getBankCard() {
		return bankCard;
	}

	public void setBankCard(MultipartFile bankCard) {
		this.bankCard = bankCard;
	}

	public MultipartFile getHardIdCardZ() {
		return hardIdCardZ;
	}

	public void setHardIdCardZ(MultipartFile hardIdCardZ) {
		this.hardIdCardZ = hardIdCardZ;
	}
}
