!function() {
    ...
    function() {
        var t = $(this),
        a = t.index(),
        r = e.demo1.children("p").eq(a),
        n = r.position().top;
        switch (e.demo1.animate({
            scrollTop: e.demo1.scrollTop() + n
        },
        0), a) {
        case 0:
            var o = -1; !
            function s() {
                var e = parent.layer.alert("点击确认更换图标", {
                    icon: o,
                    shadeClose: !0,
        ...
        case 1:
            ...
            function p() {
                ...
                p);
                9 === ++o && parent.layer.confirm("怎么样，是否很喜欢该皮肤，去下载？", {
                    skin: "layer-ext-moon"
                },
                function(e, t) {
        ...
        case 14:
            ...
            function(e) {
                ...
                function(t) {
                    parent.layer.msg("演示完毕！您的口令：" + e + "<br>您最后写下了：" + t)
                })
            });
            break;
        case 15:
            ...
            break;
        case 16:
            e.photoJSON ? layer.photos({
                photos: e.photoJSON
            }) : $.getJSON("js/demo/photos.json?v=",
            function(t) {
                e.photoJSON = t,
                layer.photos({
                    photos: t
